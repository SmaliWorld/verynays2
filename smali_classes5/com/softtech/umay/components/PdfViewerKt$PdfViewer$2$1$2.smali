.class final Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1;->invoke(Landroidx/compose/foundation/lazy/LazyListScope;)V
.end annotation
...
# direct methods
.method constructor <init>(Landroid/graphics/pdf/PdfRenderer;ILandroid/content/Context;IJLandroidx/compose/runtime/State;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$renderer:Landroid/graphics/pdf/PdfRenderer;

    iput p2, p0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$width:I

    iput-object p3, p0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$context:Landroid/content/Context;

    iput p4, p0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$height:I

    iput-wide p5, p0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$backgroundColor:J

    iput-object p7, p0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$pageCount$delegate:Landroidx/compose/runtime/State;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->invoke(Landroidx/compose/foundation/lazy/LazyItemScope;ILandroidx/compose/runtime/Composer;I)V
...
.method public final invoke(Landroidx/compose/foundation/lazy/LazyItemScope;ILandroidx/compose/runtime/Composer;I)V
    ...
    const-string v5, "com.softtech.umay.components.PdfViewer.<anonymous>.<anonymous>.<anonymous> (PdfViewer.kt:82)"
    ...
    :cond_4
    iget-object v3, v0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$renderer:Landroid/graphics/pdf/PdfRenderer;
    ...
    iget v5, v0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$width:I

    invoke-static {v3, v5}, Lcom/softtech/umay/components/PdfViewerKt;->access$renderAndClose(Landroid/graphics/pdf/PdfRenderer$Page;I)Landroid/graphics/Bitmap;
    ...
    iget-object v8, v0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$context:Landroid/content/Context;

    invoke-direct {v6, v8}, Lcoil/request/ImageRequest$Builder;-><init>(Landroid/content/Context;)V

    .line 87
    iget v8, v0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$width:I

    iget v9, v0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$height:I
    ...
    .line 94
    iget-wide v9, v0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$backgroundColor:J
    ...
    .line 99
    iget-object v4, v0, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2$1$2;->$pageCount$delegate:Landroidx/compose/runtime/State;

    invoke-static {v4}, Lcom/softtech/umay/components/PdfViewerKt$PdfViewer$2;->access$invoke$lambda$2(Landroidx/compose/runtime/State;)I
