...
.method public apply(Lorg/tensorflow/lite/support/image/TensorImage;)Lorg/tensorflow/lite/support/image/TensorImage;
    ...
    sget-object v8, Lorg/tensorflow/lite/support/image/ops/TransformToGrayscaleOp;->BITMAP_RGBA_GRAYSCALE_TRANSFORMATION:[F
    ...
    invoke-virtual {v5, v7, v8, v8, v6}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    .line 98
    invoke-virtual {v1, v13, v0}, Lorg/tensorflow/lite/support/tensorbuffer/TensorBuffer;->loadArray([I[I)V
    ...
    invoke-virtual {p1, v1, v0}, Lorg/tensorflow/lite/support/image/TensorImage;->load(Lorg/tensorflow/lite/support/tensorbuffer/TensorBuffer;Lorg/tensorflow/lite/support/image/ColorSpaceType;)V
