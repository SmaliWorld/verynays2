.class public Lorg/jnbis/internal/record/reader/UserDefinedImageReader;
.super Lorg/jnbis/internal/record/reader/RecordReader;
.source "UserDefinedImageReader.java"
...
.method public bridge synthetic read(Lorg/jnbis/internal/NistHelper$Token;)Lorg/jnbis/internal/record/BaseRecord;
    ...
    .line 9
    invoke-virtual {p0, p1}, Lorg/jnbis/internal/record/reader/UserDefinedImageReader;->read(Lorg/jnbis/internal/NistHelper$Token;)Lorg/jnbis/record/UserDefinedImage;
...
.method public read(Lorg/jnbis/internal/NistHelper$Token;)Lorg/jnbis/record/UserDefinedImage;
    .locals 8
    ...
    .line 17
    new-instance v0, Lorg/jnbis/record/UserDefinedImage;

    invoke-direct {v0}, Lorg/jnbis/record/UserDefinedImage;-><init>()V

    .line 20
    invoke-virtual {p0, p1}, Lorg/jnbis/internal/record/reader/UserDefinedImageReader;->readInt(Lorg/jnbis/internal/NistHelper$Token;)J
    ...
    .line 34
    invoke-virtual {v0, v4}, Lorg/jnbis/record/UserDefinedImage;->setImageData([B)V
    ...
    invoke-virtual {v0, p1}, Lorg/jnbis/record/UserDefinedImage;->setLogicalRecordLength(Ljava/lang/String;)V
    ...
    const-string v0, "T7::NULL pointer to T7 record"
