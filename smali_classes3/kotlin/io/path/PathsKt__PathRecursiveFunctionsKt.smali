...
.method public static final copyToRecursively(Ljava/nio/file/Path;Ljava/nio/file/Path;Lkotlin/jvm/functions/Function3;ZLkotlin/jvm/functions/Function3;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, v0}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, v1}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p1, v1}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p1}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;)Z
    ...
    invoke-static {p1, v1}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v1

    new-array v0, v0, [Ljava/nio/file/LinkOption;

    invoke-static {p0, v0}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;

    move-result-object v0

    invoke-static {v1, v0}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    ...
    .line 180
    :cond_4
    invoke-static {p1}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {v1, v2}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {v1, v2}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;
    ...
    .line 183
    invoke-static {p0, p1, p2}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/nio/file/FileSystemException;
    ...
    .line 160
    :cond_7
    invoke-static {}, Lki0$$ExternalSyntheticApiModelOutline0;->m$1()V
    ...
    invoke-static {p0, p1, p2}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/nio/file/NoSuchFileException;
...
.method private static final copyToRecursively$destination$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {p1, p0}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/Path;
...
.method public static final deleteRecursively(Ljava/nio/file/Path;)V
    ...
    invoke-static {v0}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;)Ljava/nio/file/FileSystemException;
...
.method private static final deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/Path;)Ljava/util/List;
    ...
    .line 328
    :try_start_0
    invoke-static {v4}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;)Ljava/nio/file/DirectoryStream;
    ...
    :try_start_1
    invoke-static {v5}, Lki0$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/nio/file/DirectoryStream;

    move-result-object v6

    .line 330
    invoke-static {v6}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Z
    ...
    .line 333
    invoke-static {v6}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/nio/file/SecureDirectoryStream;
...
.method private static final enterDirectory$PathsKt__PathRecursiveFunctionsKt(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    .line 385
    :try_start_2
    invoke-static {p0}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/nio/file/SecureDirectoryStream;

    move-result-object p1

    .line 386
    invoke-static {p1}, Lcom/huawei/hms/push/g$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/SecureDirectoryStream;)Ljava/util/Iterator;
...
.method private static final toFileVisitResult$PathsKt__PathRecursiveFunctionsKt(Lkotlin/io/path/CopyActionResult;)Ljava/nio/file/FileVisitResult;
    ...
    .line 244
    invoke-static {}, Lki0$$ExternalSyntheticApiModelOutline0;->m$2()Ljava/nio/file/FileVisitResult;
    ...
    .line 243
    :cond_1
    invoke-static {}, Lki0$$ExternalSyntheticApiModelOutline0;->m$1()Ljava/nio/file/FileVisitResult;
    ...
    .line 242
    :cond_2
    invoke-static {}, Lki0$$ExternalSyntheticApiModelOutline0;->m()Ljava/nio/file/FileVisitResult;
